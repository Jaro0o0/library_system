                            ...
                            <motion.div className="grid grid-cols-3 gap-6 "
                                ...
                                {authors.map((author, index) => {
                                    return(
                                        <motion.div
                                            key={index}
                                            className={`p-9 ${choose.includes(author.name) ? "bg-black" : "bg-amber-50" } flex items-center   flex flex-col rounded-2xl shadow-md border border-gray-300 hover:border-green-400 hover:shadow-lg hover:-translate-y-1 transition-all duration-300`}
                                            onClick={() => {
                                                setChoose(prev => {
