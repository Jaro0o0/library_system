    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorLibraryUser", x => new { x.FavoriteAuthorsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_AuthorLibraryUser_Authors_FavoriteAuthorsId",
                        column: x => x.FavoriteAuthorsId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthorLibraryUser_Users_UsersId",
                        column: x => x.UsersId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorLibraryUser_UsersId",
                table: "AuthorLibraryUser",
                column: "UsersId");
