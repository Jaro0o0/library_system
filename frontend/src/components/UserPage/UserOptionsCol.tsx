                    ...
                    <div className="flex flex-col justify-between  p-8 bg-white border-r border-slate-100 shadow-sm">
                        <div className="flex flex-col gap-5">
                            ...
                            <div className="md:hidden flex justify-end">
                                <Button
                                    className="!min-w-0 !w-12 !h-12 !rounded-xl !border !border-slate-200 !bg-white !text-slate-700"
                                    variant="outlined"
                            ...
                            {/* Icons_BOX */}
                            <div className={`${isMobileMenuOpen ? "flex" : "hidden"} md:flex flex-col gap-1`}>
                                {/* Home_Icon_BOx */}
